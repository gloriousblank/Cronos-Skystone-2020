...
@Autonomous(name = "Foundation Red Neutral", group = "Autonomous")

public class RedFoundationN extends LinearOpMode{
        ...
        while (opModeIsActive()) {
            ...
            if((leftDriveFront.getCurrentPosition() <= -600 && rightDriveFront.getCurrentPosition() <= -600) || !start){
                ...
                if(!start && !third && !fifth && !stop){
                    if(leftDriveFront.getCurrentPosition() >= 860 && rightDriveFront.getCurrentPosition() >= 950){
                        second = false;
                        setPower(0);
                        foundation(0);
                        resetEncoders();
                ...
                if (!start && !third && !second && !fifth && !fourth && !stop){
                    if(leftDriveFront.getCurrentPosition() >= 1700 && rightDriveFront.getCurrentPosition() <= -1800){
                        sixth = false;
                        setPower(0);
                        resetEncoders();
                        FLWheel.setPower(0);
                        ...
                        leftDriveBack.setPower(.25);
                        leftDriveFront.setPower(.25);
                        
                        mecanumTargets(2000,-2200,-2200,2200);
                    }

                }
/*
                if (!start && !third && !second && !fifth && !fourth && !sixth && !stop){
                    if(leftDriveBack.getCurrentPosition() <= -500 && rightDriveFront.getCurrentPosition() <=-500){
                        seventh = false;
                        setPower(0);
                        resetEncoders();
                        //FLWheel.setPower(0);
                        ...
                        //FLWheel.setPower(1.0);
                        mecanumTargets(-500, -500, -500, -500);
                    }
                }
*/
    ...
    public void fourWheelPos(int br, int bl, int fr, int fl) {

...
public class DavidTest extends LinearOpMode {
    ...
    public void runOpMode()  throws InterruptedException {
        ...
        pUp = hardwareMap.servo.get("pUp");
        pDown = hardwareMap.servo.get("pDown");
        ...
        pUp.setDirection(Servo.Direction.FORWARD);
        pDown.setDirection(Servo.Direction.FORWARD);
        ...
        while (opModeIsActive()) {
            double FSPos = frontServo.getPosition();
            ...
            telemetry.addData("Front Servo Position" , FSPos);
    ...
    public void setServoPower(double a){
        pUp.setPosition(a);
        pDown.setPosition(a);
